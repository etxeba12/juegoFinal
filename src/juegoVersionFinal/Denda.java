...
public class Denda {
	...
	private void mugimenduakEsleitu() {
		...
		while(i<=4) { 
			...
			if(!dago) {
				Mugimendu mugimendua = MugimenduKolekzioa.getNireMugimenduKolekzioa().MugimenduakEsleitu(zenbAleatorio); //aleatorioki erabakitako mugimendua bariable batean gordetzeko
	...
	public Mugimendu erosiMugimendu() {// Hay que comprobar desde el main si tenemos dinero para comprar el movimiento
